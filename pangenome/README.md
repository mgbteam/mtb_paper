...
This Snakemake pipeline determines core and accessory genes among 6 *M. tuberculosis* clinical reference strains from lineages 1 and 2 ([Heiniger et al., 2026](https://doi.org/10.64898/2026.01.27.701740)) with and without the model strain H37Rv included. The pangenomes calculated with [Roary](https://github.com/sanger-pathogens/Roary) and [Panaroo](https://github.com/gtonkinhill/panaroo) (which should be more accurate for *M. tuberculosis*) are compared based on the overlap, size and alignment entropy of the predicted orthogroups. Additionally, the quality of the pangenome is estimated by identifying potentially missed orthogroups using [PanQC](https://github.com/maxgmarin/panqc).
